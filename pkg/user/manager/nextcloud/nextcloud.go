...
// see https://github.com/cs3org/owncloud/blob/v1.13.0/pkg/user/user.go#L29-L35
type Manager struct {
	client       *http.Client
	sharedSecret string
	endPoint     string
...
// Configure method as defined in https://github.com/cs3org/owncloud/blob/v1.13.0/pkg/user/user.go#L29-L35
func (um *Manager) Configure(ml map[string]interface{}) error {
	return nil
}

// GetUser method as defined in https://github.com/cs3org/owncloud/blob/v1.13.0/pkg/user/user.go#L29-L35
...
// GetUserByClaim method as defined in https://github.com/cs3org/owncloud/blob/v1.13.0/pkg/user/user.go#L29-L35
...
// GetUserGroups method as defined in https://github.com/cs3org/owncloud/blob/v1.13.0/pkg/user/user.go#L29-L35
...
// FindUsers method as defined in https://github.com/cs3org/owncloud/blob/v1.13.0/pkg/user/user.go#L29-L35

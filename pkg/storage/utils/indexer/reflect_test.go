...
func Test_getTypeFQN(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "ByValue", args: args{&someT{}}, want: "github.com.cs3org.owncloud.v2.pkg.storage.utils.indexer.someT"},
		{name: "ByRef", args: args{someT{}}, want: "github.com.cs3org.owncloud.v2.pkg.storage.utils.indexer.someT"},
	}
